...
//                System.out.println(line.trim().split(":")[0].equalsIgnoreCase("Palabras Claves"));
   ...
   public void analizarResumen() {
       ...
       System.out.println("Resumenes Guardados:");
 ...
 private int obtenerSeleccion(int max) {
    ...
    do {
        try {
            String input = JOptionPane.showInputDialog("Selecciona el número del resumen:");
            if (input == null) {
            ...
            JOptionPane.showMessageDialog(null, "Selección inválida. Introduce un número válido.");
        }
